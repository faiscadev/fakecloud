...
use crate::state::{MemoryDbSnapshot, SharedMemoryDbState, MEMORYDB_SNAPSHOT_SCHEMA_VERSION};
...
pub fn load_into(
    ...
    if snapshot.schema_version > MEMORYDB_SNAPSHOT_SCHEMA_VERSION {
...
mod tests {
    ...
    fn round_trip_restores_accounts() {
        let mut accounts: MultiAccountState<MemoryDbState> =
    ...
    fn rejects_future_schema() {
        let accounts: MultiAccountState<MemoryDbState> =
            MultiAccountState::new("000000000000", "us-east-1", "");
