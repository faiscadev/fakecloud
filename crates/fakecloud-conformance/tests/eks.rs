...
#[test_action("eks", "CreateCluster", checksum = "41803caf")]
#[test_action("eks", "DescribeCluster", checksum = "07c4b232")]
#[test_action("eks", "ListClusters", checksum = "464ec628")]
#[test_action("eks", "DeleteCluster", checksum = "22074ddb")]
#[test_action("eks", "UpdateClusterConfig", checksum = "ec619e2c")]
#[test_action("eks", "UpdateClusterVersion", checksum = "e28534f7")]
#[test_action("eks", "DescribeUpdate", checksum = "d33b65ea")]
...
#[test_action("eks", "UpdateNodegroupConfig", checksum = "707cab7a")]
#[test_action("eks", "UpdateNodegroupVersion", checksum = "266412ae")]
...
#[test_action("eks", "UpdateAddon", checksum = "65d7fd30")]
...
#[test_action("eks", "AssociateIdentityProviderConfig", checksum = "120e1e14")]
#[test_action("eks", "DisassociateIdentityProviderConfig", checksum = "d1cabe6a")]
...
#[test_action("eks", "AssociateEncryptionConfig", checksum = "f22e4713")]
#[test_action("eks", "CancelUpdate", checksum = "f06faa8f")]
#[test_action("eks", "DeregisterCluster", checksum = "ef1b8c74")]
#[test_action("eks", "RegisterCluster", checksum = "6e5daed3")]
...
#[test_action("eks", "UpdateCapability", checksum = "47a56658")]
