...
A free, open-source local AWS emulator for integration testing and local development. For every service it implements, the goal is 100% behavioral parity with real AWS — measured by a schema-driven [conformance harness](/docs/about/conformance/) that runs 117,474 generated test variants against official AWS Smithy models on every commit, all of which pass.
...
That's why the project prioritizes conformance and cross-service wiring over breadth. 40 services at true 100% (117,474/117,474 Smithy variants pass) is more useful than 100 services at 50%.
