...
**Not a drop-in for all of AWS.** It implements 88 services — the ones most teams actually test against. If you need EKS, Redshift, or SageMaker, fakecloud isn't the right tool (yet).
...
That's why the project prioritizes conformance and cross-service wiring over breadth. 88 services at true 100% (200,024/200,024 Smithy variants pass) is more useful than 100 services at 50%.
