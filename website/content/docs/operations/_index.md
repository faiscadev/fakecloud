...
## Services without an AWS Smithy model file

fakecloud implements these services, but no first-party Smithy model ships in [`aws-models/`](https://github.com/faiscadev/fakecloud/tree/main/aws-models). Operation lists for these live on their per-service pages and in the [parity matrix](@/docs/parity.md).
