...
description = "fakecloud is a free, open-source local AWS emulator: 42 services, 3,726 operations, 124,508/124,508 Smithy variants pass (true 100% conformance), 6 test-assertion SDKs. No account, no token, no paid tier. Drop-in replacement for LocalStack Community."
template = "page.html"
aliases = [
...
- **3,726 API operations. True 100% conformance** across every implemented service — 124,508/124,508 Smithy-model-generated test variants pass on every commit.
