...
description = "fakecloud is a free, open-source local AWS emulator: 39 services, 2,607 operations, 86,327/86,327 Smithy variants pass (true 100% conformance), 6 test-assertion SDKs. No account, no token, no paid tier. Drop-in replacement for LocalStack Community."
template = "page.html"
+++
...
- **2,607 API operations. True 100% conformance** across every implemented service — 86,327/86,327 Smithy-model-generated test variants pass on every commit.
