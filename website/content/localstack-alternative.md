...
description = "fakecloud is a free, open-source local AWS emulator: 79 services, 5,611 operations, 187,837/187,837 Smithy variants pass (true 100% conformance), 6 test-assertion SDKs. No account, no token, no paid tier. Drop-in replacement for LocalStack Community."
template = "page.html"
aliases = [
...
- **5,611 API operations. True 100% conformance** across every implemented service — 187,837/187,837 Smithy-model-generated test variants pass on every commit.
