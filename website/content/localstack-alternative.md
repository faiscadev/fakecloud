...
description = "fakecloud is a free, open-source local AWS emulator: 104 services, 6,959 operations, 231,585/231,585 Smithy variants pass (true 100% conformance), 6 test-assertion SDKs. No account, no token, no paid tier. Drop-in replacement for LocalStack Community."
template = "page.html"
aliases = [
...
- **6,959 API operations. True 100% conformance** across every implemented service — 231,585/231,585 Smithy-model-generated test variants pass on every commit.
