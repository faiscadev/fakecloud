...
description = "fakecloud is a free, open-source local AWS emulator: 50 services, 3,932 operations, 130,944/130,944 Smithy variants pass (true 100% conformance), 6 test-assertion SDKs. No account, no token, no paid tier. Drop-in replacement for LocalStack Community."
template = "page.html"
aliases = [
...
- **3,932 API operations. True 100% conformance** across every implemented service — 130,944/130,944 Smithy-model-generated test variants pass on every commit.
...
| Conformance methodology | Smithy-model-validated, 130,944/130,944 variants pass | Not published |
