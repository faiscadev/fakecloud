...
description = "fakecloud is a free, open-source local AWS emulator: 41 services, 3,717 operations, 124,255/124,255 Smithy variants pass (true 100% conformance), 6 test-assertion SDKs. No account, no token, no paid tier. Drop-in replacement for LocalStack Community."
template = "page.html"
aliases = [
...
- **3,717 API operations. True 100% conformance** across every implemented service — 124,255/124,255 Smithy-model-generated test variants pass on every commit.
