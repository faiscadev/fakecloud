...
date = 2026-05-17
description = "A performance and conformance comparison of fakecloud, LocalStack, and Moto, focusing on startup latency, binary overhead, and API fidelity as of 2026."
...
As of May 13, 2026, fakecloud supports 2,422 operations across 33 services, including:
...
fakecloud requires no account, no token, and no internet connection. You run the binary, and it listens on port 4566. 
...
Because fakecloud implements the full API shape, your AI coding agents (like Cursor or GitHub Copilot) can write and test Bedrock-integrated code locally without incurring costs or hitting rate limits.
...
fakecloud is not a collection of isolated mocks. It is a wired environment. It supports 30+ service-to-service integrations that execute end-to-end:
