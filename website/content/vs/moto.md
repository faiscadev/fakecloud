...
| Service count | 40 at true 100% conformance (depth-first) | 100+ at varying depth (breadth-first) |
| Conformance methodology | Smithy-validated, 109,053/109,053 test variants pass on every commit | Not published |
