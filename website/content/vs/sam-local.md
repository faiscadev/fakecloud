...
fakecloud runs Lambda the same way — real runtime containers, 23 runtimes supported — and also runs 39 other AWS services end-to-end at true 100% Smithy conformance (100,594/100,594 variants pass).
