...
fakecloud runs Lambda the same way — real runtime containers, 23 runtimes supported — and also runs 40 other AWS services end-to-end at true 100% Smithy conformance (125,345/125,345 variants pass).
