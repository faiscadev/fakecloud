...
description = "How fakecloud compares to AWS SAM Local. Scope difference: SAM Local runs Lambda + limited API Gateway; fakecloud runs 39 services with real cross-service wiring."
template = "page.html"
+++
