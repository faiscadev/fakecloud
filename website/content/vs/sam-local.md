...
fakecloud runs Lambda the same way — real runtime containers, 23 runtimes supported — and also runs 45 other AWS services end-to-end at true 100% Smithy conformance (126,556/126,556 variants pass).
