...
fakecloud runs Lambda the same way — real runtime containers, 23 runtimes supported — and also runs 38 other AWS services end-to-end at true 100% Smithy conformance (99,678/99,678 variants pass).
