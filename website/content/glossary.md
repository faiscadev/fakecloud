...
### Conformance
The automated check that fakecloud's responses match AWS's [Smithy](#smithy) models exactly. fakecloud's conformance harness runs **129,882 generated test variants** on every commit, all of which pass. See [How conformance works](/docs/about/conformance/).
